...
export const BurnButton: FC<Props> = ({
    ...
    return (
        <div>
            {amount !== 0 && !isburning &&
                <button className="btn btn-primary uppercase mb-5" onClick={() => { if (publicKey) burnTokenAndCloseAccount(tokenMintAddress, publicKey, wallet, connection, amount, setAmount, setIsburning); else setVisible(true) }}>IZ-INERATE!</button>
            }
